...
public class FileHandler {
    ...
    public List<String> getExams() {
        ...
        try (BufferedReader r = new BufferedReader(new FileReader(path + "exams.txt"))) {
            String line;
    ...
    public List<String> getQuestions(String id) {
        ...
        try (BufferedReader r = new BufferedReader(new FileReader(path + "q_" + id + ".txt"))) {
            String line;
    ...
    public void saveScore(String id, String student, int score) {
        try (FileWriter w = new FileWriter(path + "sub_" + id + ".txt", true)) {
    ...
    public List<Integer> getScores(String id) {
        ...
        try (BufferedReader r = new BufferedReader(new FileReader(path + "sub_" + id + ".txt"))) {
            String line;
